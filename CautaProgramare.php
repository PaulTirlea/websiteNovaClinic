 ...
 <div class="container mt-5">
    <div class="row">
        <div class="col-md-6 offset-md-3 border p-4 shadow bg-light">
            <div class="col-12">
                <h3 class="fw-normal text-secondary fs-4 text-uppercase mb-4">Gasiti programarea</h3>
            </div>
            <form method="post" action="Cauta.php">
                <div class="row g-3">
                    ...
                    <div class="col-12 mt-5">                        
                        ...
                        <a href="Cauta.html"><button type="button" class="btn btn-outline-secondary float-end me-2">Anuleaza</button></a>
                    </div>
                </div>
            </form>
        </div>
