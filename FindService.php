...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-6 offset-md-3 border p-4 shadow bg-light">
            <div class="col-12">
                <h3 class="fw-normal text-secondary fs-4 text-uppercase mb-4">Gasiti serviciul</h3>
            </div>
            <form method="post" action="FindServiceResult.php" enctype="multipart/form-data">
                <div class="row g-3">
                    <div class="col-md-6">
