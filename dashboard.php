  ...
  <div class="container">
    <div class="row">
      <div class="col-md-10">
        ...
        <a href="seedoctors.php"><button type="button" class="btn btn-info">See Doctors</button></a>
        <a href="DoctorsPage.php"><button type="button" class="btn btn-outline-info">Add new Doctor</button></a>
        </br>
        </br>
        <a href="FindDoctors.php"><button type="button" class="btn btn btn-info btn-sm">Find Doctor</button></a>
        <a href="DeleteDoctor.php"><button type="button" class="btn btn btn-outline-info btn-sm">Delete Doctor</button></a>
      </div>
    </div>
  </div>
</div>
